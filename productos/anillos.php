...
<body>
    ...
    ?>    
            <div class="col">
                <div class="card h-100">
                    <img src="<?php echo $row['imagen'] ?>" class="card-img-top tpC" alt="anillo">
                    <div class="card-body">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center mt-2">                
            <li class="page-item"><a class="page-link" href = "/servicios/productos/anillos.php?p=1">1</a></li>
            <li class="page-item"><a class="page-link" href = "/servicios/productos/anillos.php?p=2">2</a></li>             
        </ul>
    </nav>
